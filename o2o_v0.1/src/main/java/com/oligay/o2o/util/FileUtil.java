...
public class FileUtil {
    ...
    public static String getImgBasePath() {
        ...
        if (os.toLowerCase().startsWith("win")) {
            ...
            basePath = "/Users/guoqs/Documents/JavaProject/ssmProject/o2o/image";
        }
...
//        String waterMarkImg = basePath + "/watermark/watermark.png";
        String waterMarkImg = basePath + "/watermark.jpeg";
        waterMarkImg = waterMarkImg.replace("/", seperator);
        System.out.println(2 + ":" + waterMarkImg);
